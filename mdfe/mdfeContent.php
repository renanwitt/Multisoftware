<!-- Início das questões sobre CTE-->

<div class="container">
<span style="font-size:16px; font-weight:bold;">&#8227; DÚVIDAS SOBRE MDF-e</span><br>
<div id="accordion">
   <div class="card">
    <div class="card-header" id="headingOne">
      <h5 class="mb-0">
        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
          Informações necessárias para emitir um MDFe
        </button>
      </h5>
    </div>
    ...
    <div class="card-header" id="headingTwo">
      <h5 class="mb-0">
        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
          O que devo saber antes de emitir um MDF-e?
        </button>
      </h5>
    </div>
    ...
    <div class="card-header" id="headingSix">
      <h5 class="mb-0">
        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
          O que devo saber antes de encerrar um MDFe?
        </button>
      </h5>
    </div>
